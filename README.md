...
>
> When compiling statically-linked computer programs, the richness and vocabulary includes all of the same arithmetic we learned in school, plus some more stuff. This project is a compiler treating "Math" as its programming language, and `tix86` being the compiler that supports x86_64 executable generation.
