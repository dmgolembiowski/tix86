...
>
> When compiling statically-linked computer programs, the richness and vocabulary includes all of the same arithmetic we learned in school, plus some more stuff. This project is a compiler for math itself, not a programming language.
>
